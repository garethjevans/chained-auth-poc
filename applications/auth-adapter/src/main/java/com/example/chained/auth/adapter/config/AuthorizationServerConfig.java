...
public class AuthorizationServerConfig {
  ...
  @Bean
  @Order(1)
  public SecurityFilterChain authorizationServerSecurityFilterChain(HttpSecurity http, OAuth2AuthorizedClientManager  oAuth2AuthorizedClientManager)
      throws Exception {
    http
            ...
            (authorizationServer) -> {
              ...
              authorizationServer.addObjectPostProcessor(
                  PocOAuth2AuthorizationCodeRequestAuthenticationProvider.postProcessor(http, oAuth2AuthorizedClientManager));
            })
