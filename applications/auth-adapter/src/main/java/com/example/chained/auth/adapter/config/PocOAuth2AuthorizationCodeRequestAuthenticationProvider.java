...
public class PocOAuth2AuthorizationCodeRequestAuthenticationProvider
  ...
  public PocOAuth2AuthorizationCodeRequestAuthenticationProvider(
          ...
          OAuth2AuthorizationService authorizationService, OAuth2AuthorizedClientManager authorizedClientManager) {
  ...
  public static ObjectPostProcessor<AuthenticationProvider> postProcessor(HttpSecurity http, OAuth2AuthorizedClientManager authorizedClientManager) {
